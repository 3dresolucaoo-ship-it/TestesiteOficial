...
| `/api/webhooks/payment` | POST | ✅ OK — middleware libera (Otávio 17/05), MP signature obrigatória. Handler genérico de checkout marketplace (Stripe/MP). Rota `?merchant=calc-pro` REMOVIDA 2026-05-21 (Calc Pro descontinuado). |
...
| ~~`/api/calc-pro/status`~~ | GET | ❌ REMOVIDA 2026-05-21 — Calc Pro descontinuado pelo CEO. |
