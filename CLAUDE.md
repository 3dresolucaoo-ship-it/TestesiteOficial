...
- **Pendência prioritária #3**: **Rotacionar chaves** expostas no chat (RESEND_API_KEY + SUPABASE_SERVICE_ROLE_KEY) — Resend Dashboard → API Keys (gera nova, atualiza Vercel env). 5min.
