...
- **🤖 3 Routines ativas em prod** (2026-05-17 noite): `audit-mensal` (dia 1, 9h BRT — `0 12 1 * *` UTC), `pillars-review-semanal` (segunda, 9h BRT — `0 12 * * 1` UTC, **roda amanhã 18/05**), `estudo-g7-semanal` (terça, 9h BRT — `0 12 * * 2` UTC, roda 19/05). Repo: TestesiteOficial. Conectores: Supabase + Vercel. Permissão git push direto OFF (cria PR sempre). Custo: ~9 runs/mês de 450 disponíveis no Max (~2%). Specs em `automation/routines-specs.md`, ADR-015.
