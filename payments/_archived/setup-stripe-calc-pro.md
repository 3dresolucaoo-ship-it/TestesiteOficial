> ⚠️ ARQUIVADO 2026-05-21 — Calc Pro freemium revogada (ver `decisions/024-calc-gratis-magnet-eterno.md`)
> Este guia era válido para o ADR-023, que foi substituído pelo ADR-024.
> Mantido como referência histórica. NÃO executar os passos abaixo.
...
- `decisions/023-calc-pro-freemium-subscription.md` — ADR completo (revogado)
- `decisions/024-calc-gratis-magnet-eterno.md` — ADR que substituiu esta decisão
- `supabase/migrations/20260520_calc_pro_subscriptions.sql` — schema da tabela (nunca aplicada em prod)
